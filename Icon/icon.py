...
draw.rectangle(((16., 32.), (224., 224.)), fill='white')
...
spectrum_line = [(x + 16, int(icon_size[1] / 2)) for x in range(208)]
draw.line(spectrum_line, fill=spectrum_color, width=wave_width)

frame_color = (196, 196, 196, 255)
frame_thickness = 4
draw.rectangle(((16., 32.), (224., 224.)), outline=frame_color, width=frame_thickness)
